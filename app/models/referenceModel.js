...
function ReferenceModel() {
    ...
    self.businessUnitList = ko.observableArray([
        { name: "DMIT", fullName: "DMIT" },
        { name: "P&I", fullName: "P&I" },
        { name: "TCE", fullName: "TCE" }
    ]);

    self.portfolioList = ko.observableArray([
        { name: 'AOE', label: 'Acquisition, Operations, and Engineering' },
        { name: 'EIT', label: 'Enterprise IT' },
        { name: 'IAO', label: 'Intelligence Analysis and Operations' },
        { name: 'PL', label: 'Preparedness and Logistics' },
        { name: 'TS', label: 'Training and Simulation' }
    ])

    self.practiceList = ko.observableArray([
